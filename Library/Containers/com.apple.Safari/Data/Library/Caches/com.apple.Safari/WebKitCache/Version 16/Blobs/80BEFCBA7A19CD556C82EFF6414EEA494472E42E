...
g.k.E5=function(){this.player.playVideo()};
...
g.k.Lq=function(){};
g.k.iE=function(){};
g.k.Jr=function(){};g.w(Adb,g.iR);g.k=Adb.prototype;g.k.onVideoDataChange=function(){if(this.player.N("web_rounded_containers")&&this.player.getVideoData()){var a=16/9;a=this.player.getVideoAspectRatio()>a+.1;g.qo(this.player.getRootNode(),"ytp-rounded-miniplayer-extra-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.hR("miniplayer",Adb);})(_yt_player);
